...
if __name__ == "__main__":
    feature_dir = '/workspace/data/facescrub-features/insightface-r100-spa-m2.0-ep96'
    feature_list_path = os.path.join('../data/facescrub/facescrub-mtcnn-aligned-112x112-image-list.txt')
    ...
    save_type = '_feat.bin'
    save_dir = '/workspace/data/facescrub-features/pca-insightface-r100-spa-m2.0-ep96/pca-320-split0'
